  ...
  defp docs do
    [
      ...
      extras: [
        ...
        "guides/06-in-memory-state/introduction.md",
        "guides/06-in-memory-state/agent.livemd",
        "guides/06-in-memory-state/ets.livemd",
        "guides/06-in-memory-state/dets.livemd",
        "guides/06-in-memory-state/persistent-term.livemd",
      ...
      groups_for_extras: [
        ...
        Essentials: [~r"/04-essentials/"],
        Async: [~r"/05-async/"],
        "In-memory State": [~r"/06-in-memory-state/"],
